 ...
 */
//@Singleton
public class ShopsTableDataGateway extends AbstractTableDataGateway {
    //    @PersistenceUnit
//    EntityManager em;
    ...
    public Object findId(AbstractEntity entity) throws NamingException {
        if (entity instanceof Shop) {
            ...
            Query query = em.createNamedQuery("Shop.findId")
                                .setParameter("shop_name", shop.getShop_name())
                                .setParameter("shop_company", shop.getShop_company());
            Object ob = 0;
