 ...
 */
//@Singleton
public class CurrenciesTableDataGateway extends AbstractTableDataGateway {
    //    @PersistenceUnit
//    EntityManager em;
    ...
    public Object findId(AbstractEntity entity) throws NamingException {
        if (entity instanceof Currency) {
            ...
            Query query = em.createNamedQuery("Currency.findId")
                                .setParameter("shop_currency_id", currency.getShop_currency_id())
                                .setParameter("shop_id", currency.getShop().getId());
            Object ob = 0;
            try {
