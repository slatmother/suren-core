...
public class ShopDataProcessor {
    ...
    public void persistShopData(YmlCatalog catalog) throws Exception {
        ...
        for (Category category : categories) {
            ...
            Integer category_id = (Integer) category.findId();
        ...
        for (Offer offer : offers) {
            ...
            Integer offer_id = (Integer) offer.findId();
            ...
            if (offerParams != null && !offerParams.isEmpty()) {
                for (OfferParam offerParam : offerParams) {
                    ...
                    Integer offerParam_id = (Integer) offerParam.findId();
        ...
        for (Currency currency : currencies) {
            ...
            Integer currency_id = (Integer) currency.findId();
